    ...
    public class AEPSTransactionController : Controller
    {
        ...
        public IActionResult Index(AEPSTransactionModel input)
        {
            try
            {
                ...
                listParam.Add(new KeyValuePair<string, string>("senderMobileNumber", input.SenderMobileNumber ?? "0"));
                listParam.Add(new KeyValuePair<string, string>("aadharNumber", input.AadharNumber?? "0"));
