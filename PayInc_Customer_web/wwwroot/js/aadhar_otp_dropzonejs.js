...
var KTDropzoneDemo = function () {
    ...
    var demo1 = function () {
        ...
        $('#kt_dropzone_1').dropzone({
            url: "/OnBoarding/AadharOTP/UploadPancard",
        ...
        $('#kt_dropzone_2').dropzone({
            url: "/OnBoarding/AadharOTP/UploadVoterID",
            paramName: "file1",
            maxFiles: 1,
            timeout: 180000,
            maxFilesize: 10,
        ...
        $('#kt_dropzone_4').dropzone({
            url: "/OnBoarding/AadharOTP/UploadDL",
            paramName: "file2",
            uploadMultiple: false,
            maxFiles: 1,
            timeout: 180000,
        ...
        $('#kt_dropzone_5').dropzone({
            url: "/OnBoarding/AadharOTP/UploadCancelledCheque",
            paramName: "file2",
            maxFiles: 1,
            maxFilesize: 10,
            addRemoveLinks: true,
